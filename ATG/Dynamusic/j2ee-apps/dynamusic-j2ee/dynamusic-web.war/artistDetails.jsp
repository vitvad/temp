      ...
      <tr>
        ...
        <td width="100" bgcolor="ghostwhite" valign="top">
          ...
          <font face="Verdana,Geneva,Arial" size="-1" color="steelblue">
            <b><dsp:a href="editArtist.jsp"><dsp:param name="artistId" param="itemId" />Edit Artist Info</dsp:a></b></font>     
        </td>
...
<dsp:droplet name="/dynamusic/ArtistLookupDroplet">
	...
	<dsp:oparam name="output">
		<table CELLPADDING=10 >
			<tr>
				<td VALIGN=TOP>
					<img SRC='<dsp:valueof param="element.photoURL" />' NOSAVE>
				</td>
				<td>
					<font face="Geneva,Arial"><font size=-2><dsp:valueof param="element.description" /></font></font>
				</td>
			</tr>
		</table>
	</dsp:oparam>
...
<dsp:droplet name="/atg/dynamo/droplet/RQLQueryForEach">
	<dsp:param name="queryRQL" value='artist.id = :itemId ORDER BY name' />
